...
const editorContainerVariants = cva(
  'relative w-full cursor-text select-text overflow-y-auto caret-primary selection:bg-primary/30 selection:text-foreground focus-visible:outline-none [&_.slate-selection-area]:z-50 [&_.slate-selection-area]:border [&_.slate-selection-area]:border-primary/50 [&_.slate-selection-area]:bg-primary/20',
  {
    defaultVariants: {
      variant: 'default',
    },
